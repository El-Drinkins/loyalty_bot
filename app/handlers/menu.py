...
async def regulations_command(message: Message):
    regulations_text = (
        ...
        "главное — не больше половины суммы аренды. Сумма баллов должна быть кратна 100 (100, 200, 500, 1000...)\n\n"
        "➖➖➖➖➖➖➖➖➖➖\n\n"
        "Как получить баллы?\n\n"
        "1. Кэшбэк за аренду\n"
        ...
        "• Совершили новую аренду (даже с оплатой баллами) — срок всех баллов снова становится 3 месяца.\n"
