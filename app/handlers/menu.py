...
async def cmd_faq(message: Message):
    ...
    faq_text = (
        ...
        " Только фотографов, видеографов и людей, имеющих непосредственное отношение к этим профессиям.\n\n"
...
async def regulations_command(message: Message):
    regulations_text = (
        ...
        "⚠️ Приглашайте только фотографов, видеографов и людей, имеющих непосредственное отношение к этим профессиям (ассистенты, стилисты, ретушёры). Заявки от людей вне профессии рассматриваться не будут.\n\n"
