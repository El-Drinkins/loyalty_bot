...
class Model(Base):
    ...
    price_per_week: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    price_per_two_weeks: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    price_per_month: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
